      ...
      <div className="container mx-auto">
        ...
        <div className="flex gap-3 mb-8 flex-wrap">
          <button
            ...
            className={`flex items-center gap-2 px-6 py-3 rounded-lg font-medium transition-all duration-300 ${
              activeTab === 'overview'
                ? 'bg-teal-500/40 border border-teal-400/60 text-white'
        ...
        {activeTab === 'overview' && (
          <>
            {isLoading && !mainStation ? (
              <div className="glass-card bg-white/35 border-white/40 backdrop-blur-md text-center py-12">
              ...
              <div className="lg:col-span-2 glass-card bg-white/35 border-white/40 backdrop-blur-md">
                <div className="mb-6">
              ...
              <div className="glass-card bg-teal-500/30 border-teal-400/40 backdrop-blur-md">
        ...
        <div className="glass-card bg-white/35 border-white/40 backdrop-blur-md">
          ...
          <Button
            ...
            className="w-full bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700 text-white font-semibold py-3 mb-4 rounded-lg transition-all duration-300"
          >
            Download as CSV
          </Button>
