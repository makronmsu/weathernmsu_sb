...
export default function WeatherAlerts({ alerts, onDismiss }: WeatherAlertsProps) {
  ...
  return (
    <div className="glass-card bg-white/40 border-white/50 backdrop-blur-md mb-6">
      ...
      <div className="space-y-3">
        {alerts.map((alert) => (
          <div
            key={alert.id}
            className={`border rounded-lg p-4 transition-all duration-300 bg-white/60 ${getAlertBgColor(alert.severity)}`}
          >
